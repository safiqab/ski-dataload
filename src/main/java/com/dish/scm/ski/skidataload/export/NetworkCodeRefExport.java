...
@Component
public class NetworkCodeRefExport {
    public void writeData(Sheet sheet, List<NetworkCodeRefVM> lstData) {
        ...
        try {
            ...
            for (NetworkCodeRefVM obj : lstData) {

                row = sheet.createRow(rowCnt++);
                row.createCell(0).setCellValue(obj.getNetwork_code());
